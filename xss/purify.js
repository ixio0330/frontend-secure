...
!(function (e, t) {
  ...
  const u = D(Array.prototype.forEach),
    m = D(Array.prototype.lastIndexOf),
    p = D(Array.prototype.pop),
    f = D(Array.prototype.push),
    d = D(Array.prototype.splice),
    h = D(String.prototype.toLowerCase),
    g = D(String.prototype.toString),
    T = D(String.prototype.match),
    y = D(String.prototype.replace),
    E = D(String.prototype.indexOf),
    A = D(String.prototype.trim),
    _ = D(Object.prototype.hasOwnProperty),
  ...
  var re = (function t() {
    ...
    const ht = r.createElement("form"),
      ...
      Tt = function () {
        ...
        if (!dt || dt !== e) {
          if (
            ...
            (e = C(e)),
            (mt =
              -1 === pt.indexOf(e.PARSER_MEDIA_TYPE)
                ? "text/html"
                : e.PARSER_MEDIA_TYPE),
            (ft = "application/xhtml+xml" === mt ? g : h),
            (Ne = _(e, "ALLOWED_TAGS") ? R({}, e.ALLOWED_TAGS, ft) : De),
            (Re = _(e, "ALLOWED_ATTR") ? R({}, e.ALLOWED_ATTR, ft) : we),
            (at = _(e, "ALLOWED_NAMESPACES")
              ? R({}, e.ALLOWED_NAMESPACES, g)
              : lt),
            (Qe = _(e, "ADD_URI_SAFE_ATTR")
              ? R(C(et), e.ADD_URI_SAFE_ATTR, ft)
              : et),
            (Ze = _(e, "ADD_DATA_URI_TAGS")
              ? R(C(Je), e.ADD_DATA_URI_TAGS, ft)
              : Je),
            (Ke = _(e, "FORBID_CONTENTS") ? R({}, e.FORBID_CONTENTS, ft) : Ve),
            (Oe = _(e, "FORBID_TAGS") ? R({}, e.FORBID_TAGS, ft) : C({})),
            (ve = _(e, "FORBID_ATTR") ? R({}, e.FORBID_ATTR, ft) : C({})),
            ($e = !!_(e, "USE_PROFILES") && e.USE_PROFILES),
            ...
            $e &&
              ((Ne = R({}, U)),
              (Re = []),
              !0 === $e.html && (R(Ne, v), R(Re, z)),
              !0 === $e.svg && (R(Ne, x), R(Re, P), R(Re, H)),
              !0 === $e.svgFilters && (R(Ne, L), R(Re, P), R(Re, H)),
              !0 === $e.mathMl && (R(Ne, I), R(Re, F), R(Re, H))),
            e.ADD_TAGS &&
              ("function" == typeof e.ADD_TAGS
                ? (xe.tagCheck = e.ADD_TAGS)
                : (Ne === De && (Ne = C(Ne)), R(Ne, e.ADD_TAGS, ft))),
            e.ADD_ATTR &&
              ("function" == typeof e.ADD_ATTR
                ? (xe.attributeCheck = e.ADD_ATTR)
                : (Re === we && (Re = C(Re)), R(Re, e.ADD_ATTR, ft))),
            e.ADD_URI_SAFE_ATTR && R(Qe, e.ADD_URI_SAFE_ATTR, ft),
            e.FORBID_CONTENTS &&
              (Ke === Ve && (Ke = C(Ke)), R(Ke, e.FORBID_CONTENTS, ft)),
            e.ADD_FORBID_CONTENTS &&
              (Ke === Ve && (Ke = C(Ke)), R(Ke, e.ADD_FORBID_CONTENTS, ft)),
            Xe && (Ne["#text"] = !0),
            Pe && R(Ne, ["html", "head", "body"]),
            Ne.table && (R(Ne, ["tbody"]), delete Oe.tbody),
      ...
      bt = function (e) {
        ...
        if (rt === ot)
          try {
            t = new Y().parseFromString(o, mt);
          } catch (e) {}
        if (!t || !t.documentElement) {
          t = se.createDocument(rt, "template", null);
          try {
    ...
    const wt = function (e) {
        let t = null;
        if ((Rt(de.beforeSanitizeElements, e, null), Nt(e))) return At(e), !0;
        ...
        if (
          ...
          return At(e), !0;
        if (e.nodeType === ee) return At(e), !0;
        if (ze && e.nodeType === te && b(/<[/\w]/g, e.data)) return At(e), !0;
        if (
          !(xe.tagCheck instanceof Function && xe.tagCheck(n)) &&
          (!Ne[n] || Oe[n])
        ) {
          if (!Oe[n] && Ot(n)) {
            ...
            return (
              ...
              (e.namespaceURI === nt
                ...
                ? t.namespaceURI === ot
                  ...
                  : Boolean(Et[n])
                : e.namespaceURI === ot
                ? !(t.namespaceURI === nt && !st[o]) &&
                  !(t.namespaceURI === tt && !ct[o]) &&
                  !Et[n] &&
                  (ut[n] || !yt[n])
                : !("application/xhtml+xml" !== mt || !at[e.namespaceURI]))
            );
          })(e)
          ? (At(e), !0)
      ...
      Ct = function (e, t, n) {
        if (Ye && ("id" === t || "name" === t) && (n in r || n in ht))
          return !1;
        if (ke && !ve[t] && b(ye, t));
        else if (Le && b(Ee, t));
        else if (
          xe.attributeCheck instanceof Function &&
          xe.attributeCheck(t, e)
        );
        else if (!Re[t] || ve[t]) {
          if (
            !(
      ...
      Ot = function (e) {
        return "annotation-xml" !== e && T(e, be);
      },
      vt = function (e) {
        ...
        for (; r--; ) {
          ...
          if (
            ...
            !je ||
              ("id" !== s && "name" !== s) ||
              (_t(a, e), (f = "user-content-" + f)),
            ze && b(/((--!?|])>)|<\/(style|title|textarea)/i, f))
          ) {
            _t(a, e);
            continue;
          }
    ...
    return (
      (o.sanitize = function (e) {
        let t =
          ...
          l = null;
        if (
          ((it = !e), it && (e = "\x3c!--\x3e"), "string" != typeof e && !Dt(e))
        ) {
        ...
        if (
          (Fe || Tt(t), (o.removed = []), "string" == typeof e && (qe = !1), qe)
        ) {
          if (e.nodeName) {
          ...
          if (!Be && !Ue && !Pe && -1 === e.indexOf("<"))
            return le && We ? le.createHTML(e) : e;
          if (((n = bt(e)), !n)) return Be ? null : We ? ce : "";
        }
        n && He && At(n.firstChild);
        const c = St(qe ? e : n);
        for (; (i = c.nextNode()); )
          wt(i), vt(i), i.content instanceof s && xt(i.content);
        if (qe) return e;
        if (Be) {
          if (Ge)
          ...
          return (
            (Re.shadowroot || Re.shadowrootmode) && (l = fe.call(a, l, !0)), l
          );
        }
        let m = Pe ? n.outerHTML : n.innerHTML;
        return (
          Pe &&
            Ne["!doctype"] &&
            n.ownerDocument &&
            ...
            b(K, n.ownerDocument.doctype.name) &&
      ...
      (o.setConfig = function () {
        Tt(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}),
          (Fe = !0);
      }),
